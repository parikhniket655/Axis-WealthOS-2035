# Axis WealthOS 2035 — Pitch Script & Feasibility Detail Guide

---

## 1. Executive Spoken Pitch Script
...
* **The 3-Person Advisory Pod Model:** We transition branches away from the single-RM structure. A Pod consists of:
  1. *Lead Relationship Partner* (owns client trust, goal discovery, and family dynamics).
